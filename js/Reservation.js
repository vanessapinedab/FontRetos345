...
function agregarReservation() {
    ...
    if($("#startDate").val() == "" || $("#devolutionDate").val() == "" || $("#status").val() == ""){
        ...
        $.ajax({
            ...
            url:"http://129.151.98.207:8080/api/Reservation/save",
...
function listarReservation(){
    $.ajax({
        url:"http://129.151.98.207:8080/api/Reservation/all",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://129.151.98.207:8080/api/Reservation/"+idElemento,
...
function cargarDatosReservation(id) {
    $.ajax({
        dataType: 'json',
        url:"http://129.151.98.207:8080/api/Reservation/"+id,
...
function actualizarReservation(idElemento) {
    ...
    if($("#startDate").val().length == 0 || $("#devolutionDate").val().length == 0 || $("#status").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://129.151.98.207:8080/api/Reservation/update",
